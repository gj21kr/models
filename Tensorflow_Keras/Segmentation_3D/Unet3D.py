...
def Unet3D(inputs, params, training):
    """
    ...
    for layer_depth in range(depth):
        ...
        layer1 = conv3d_bn_relu(
            ...
            kernel=conv_size,
            strides=[1,conv_strides,conv_strides,conv_strides,1],
            padding=padding,
        ...
        if layer_depth < depth - 1:
            ...
            print('maxpool layer: %s' % current_layer.shape)
    ...
    for layer_depth in range(depth - 2, -1, -1):
        ...
        up_conv = tf.nn.conv3d_transpose(
            current_layer,
            filters=n_filters * 2,
            strides=[pooling_strides,pooling_strides,pooling_strides],
            padding=padding,
