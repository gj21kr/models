...
def AttentionUnet(input_size, num_classes, n_filters=16, batchnorm=True, activation='sigmoid'):

    # contracting path
    inputs = Input(input_size)
    c0 = inception_block(inputs,
                         n_filters=n_filters,
                         batchnorm=batchnorm,
                         strides=1,
                         recurrent=2,
    ...
    outputs = Conv3D(filters=num_classes, kernel_size=1, strides=1, activation=activation)(u3)
