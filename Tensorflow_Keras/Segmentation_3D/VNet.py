...
def vnet_base(input_tensor, filter_num, res_num_ini=1, res_num_max=3, 
...
def vnet(input_size, num_classes,filter_num=[16,32,64,128,256],
    ...
    * All the 5-by-5 convolutional kernels are changed (and fixed) to 3-by-3.
    ...
    X = IN
    # base
    X = vnet_base(X, filter_num, res_num_ini=res_num_ini, res_num_max= res_num_max, 
