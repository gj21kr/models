...
class ViT(tf.keras.Model):
    ...
    def __init__(self, *, image_size, patch_size, num_classes, dim, depth, heads, mlp_dim, channels=3):
        super().__init__()
        assert image_sizeune % patch_size == 0, 'image dimensions must be divisible by the patch size'
        ...
        self.rearrange = Rearrange('b (d p1) (h p2) (w p3) c -> b (d h w) (p1 p2 p3 c)', p1=self.patch_size, p2=self.patch_size)
