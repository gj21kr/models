...
def Unet3D(shape, num_class=1, filters=32):    
    if num_class == 1:
        activation = 'sigmoid'
    else:
        activation = 'softmax'
    ...
    pool1 = layers.MaxPooling3D((1, 2, 2), strides=(2, 2, 2), name='pool1')(conv1_1)
    ...
    up1_5 = layers.Conv3DTranspose(nb_filter[0], (2, 2, 1), strides=(2, 2, 2), name='up15', padding='same')(conv2_4)
...
def Unet3D_2b(shape, num_class=1, filters=32, activation='sigmoid'):    
    ...
    up1_5b = layers.Conv3DTranspose(nb_filter[0], (2, 2, 1), strides=(2, 2, 2), name='up15b', padding='same')(conv2_4b)
