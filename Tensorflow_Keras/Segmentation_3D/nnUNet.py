...
def nnUNet(input_shape, feature_maps=32, max_fa=480, num_pool=8, k_init='he_normal', num_classes=1, num_channels=1):
    ...
    x = Input((*input_shape, num_channels))                                                      
    #x = Input(image_shape)                                                     
    inputs = x
    ...
    for i in range(len(fa_save)):
        ...
        seg_outputs.append(Conv3D(n_classes, (1, 1, 1), use_bias=False, activation="softmax") (x))   
